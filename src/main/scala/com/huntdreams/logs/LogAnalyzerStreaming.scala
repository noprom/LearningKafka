package com.huntdreams.logs

import com.huntdreams.logs.bean.ApacheAccessLog
import com.huntdreams.logs.util.OrderingUtils
...
object LogAnalyzerStreaming {
  ...
  def main(args: Array[String]) {
    val sparkConf = new SparkConf()
      .setAppName("Log Analyzer Streaming in Scala")
      .setMaster("local[1]")
